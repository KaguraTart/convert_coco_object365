...
classes_names = ["Crack","Patch-Crack","Pothole","Patch-Pothole","Net","Patch-Net","Manhole","Hinged-Joint"]
dataDir = 'F:/大学/coding/code/python/yolox-pytorch/赛题一A榜数据/annos'  ####### 连接到coco的数据集
headstr = """\
<annotation>
    <folder>VOC</folder>
    <filename>%s</filename>
